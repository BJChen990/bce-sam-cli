...
class ContainerManager(object):
    ...
    def run(self, container, input_data=None, warm=False):
        ...
        :param bsamcli.local.docker.container.Container container: Container to create and run
    ...
    def stop(self, container):
        ...
        :param bsamcli.local.docker.container.Container container: Container to stop
        """
        container.delete()
